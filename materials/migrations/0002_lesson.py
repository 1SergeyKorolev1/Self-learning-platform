    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(blank=True, help_text='Укажите курс', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='lesson', to='materials.course', verbose_name='Курс')),
